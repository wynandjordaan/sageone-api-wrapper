...
namespace SageOneApi
{
	public class ApiRequest
	{
		...
		public SupplierReturnRequest SupplierReturnRequest { get { return new SupplierReturnRequest(_client, _apiKey, _companyId); } }
		...
		public ApiRequest(string username, string password, string apiKey, int companyId)
		{
			...
			{
				//BaseUrl = new Uri("https://resellers.accounting.sageone.co.za/api/1.1.3"),
